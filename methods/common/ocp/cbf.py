from methods.common.ocp.config import CBFconfig, OptimConfig, IpoptConfig
from methods.common.ocp.base import OCP
from methods.common.ocp.cbf_func import CBFunctionsCasadi
from typing import Dict, Tuple, cast
import casadi as ca
import numpy as np
from numpy import ndarray

class DefaultCBF(OCP):
    def __init__(self, config: CBFconfig, metadata: Dict):
        ...
        super(DefaultCBF, self).__init__(config, metadata)
    ...
    def __call__(self, x0, u0, info, mask):
        res: Dict = super(DefaultCBF, self).__call__(x0, u0, info, mask)
